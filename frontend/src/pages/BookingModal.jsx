        ...
        >
            ...
            >
                <Form.Item name="isNewCustomer" label="Hình thức khách hàng">
                    <Radio.Group
                        onChange={(e) => form.setFieldValue('isNewCustomer', e.target.value)}
                    >
                ...
                {isNewCustomer ? (
                    <>
                        ...
                        <Form.Item name="id_card_number" label="CCCD" rules={[{ required: true }]}>
                            <Input />
                        </Form.Item>
                    ...
                    <Form.Item name="customer_id" label="Chọn khách hàng" rules={[{ required: true }]}>
                ...
                <Form.Item name="room_id" label="Chọn phòng" rules={[{ required: true }]}>
                    <Select showSearch placeholder="Tìm và chọn phòng">
                        {rooms
                            .filter(r => r.status === 'available' || r.id === editingBooking?.room.id)
                            .map(r => (
                ...
                <Form.Item name="booking_dates" label="Ngày nhận - trả phòng" rules={[{ required: true }]}>
