...
import {
  ...
  useInvoiceDetail,
} from "../contexts/InvoiceDetailContext";
import {
  Typography,
  Row,
  Col,
...
import "../css/InvoiceDetailPage.css";
...
const InvoiceDetailView = () => {
  ...
  const handlePayment = async () => {
    try {
      const response = await apiClient.post("/bookings/vnpay/create-payment/", {
        booking_id: invoiceData.booking.id,
      });

      // Chuyển hướng đến VNPAY
      window.location.href = response.data.vnpay_url;
    } catch (error) {
      message.error("Không thể tạo giao dịch thanh toán. Vui lòng thử lại!");
