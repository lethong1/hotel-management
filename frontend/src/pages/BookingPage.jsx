...
const BookingView = () => {
    ...
    const columns = [
        ...
        { title: 'Khách hàng', dataIndex: ['customer', 'full_name'], key: 'customer', width: 150 },
        { title: 'Phòng', dataIndex: ['room', 'room_number'], key: 'room', width: 50 },
        {
        ...
        { 
            ...
            key: 'status', 
            width: 90,
            render: status => <Tag color={status === 'confirmed' ? 'blue' : 'default'}>{status.toUpperCase()}</Tag> 
        },
        {
            title: 'Hành động',
            key: 'action',
    ...
    return (
        <div>
            <Button type="primary" onClick={() => showBookingModal(null)} style={{ marginBottom: 16 }}>
