# Generated by Django 5.2.2 on 2025-06-17 08:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('manager', 'Manager'), ('user', 'User')], default='user', max_length=50, unique=True, verbose_name='Vai trò')),
            ],
        ),
        migrations.CreateModel(
            name='User',
